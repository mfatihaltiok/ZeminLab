...

{
  const integrated=evaluateFoundationSystem({
    actions:{vertical:1000,vx:0,vy:0,mx:0,my:0,source:'regression design action',designAction:true},
    ...
    project:{
      ...
      foundationParameters:{foundationType:'tekil',footingWidth:2,footingLength:2,footingDepth:1,safetyFactor:3,verticalLoad:1000,horizontalLoad:0,momentX:0,momentY:0,resistanceFactorRv:1.4,vtX:100,vtY:0,structuralWeight:1000,passiveResistanceCharacteristic:0,usePassiveResistance:false,foundationInterface:'cast-in-place-soil'},
