...
const api={
  ...
  ocr:{
    analyzeImage:(dataUrl:string)=>ipcRenderer.invoke('ocr:analyze-image',{dataUrl}) as Promise<{ok:boolean;provider?:string;model?:string;lines?:Array<{text:string;score?:number|null;box?:unknown}>;error?:string}>
  },
