...
export default function ProjectInfo() {
  ...
  const update = <K extends keyof typeof project>(
    key: K,
    ...
    <div className="engineering-screen project-info-screen">
      <div className="engineering-header">
        <div>
          ...
          <div className="engineering-subtitle">
            Merkezi proje verileri ve birim sistemi
          </div>
        </div>
      </div>
      ...
      <div className="engineering-content">
        <section className="calculation-card">
          ...
          <div className="project-form-grid">
            ...
            <label>
              Proje No
              <input value={project.projectNo} onChange={(e) => update('projectNo', e.target.value)} />
            </label>
            <label>
              Tarih
              <input type="date" value={project.date} onChange={(e) => update('date', e.target.value)} />
            </label>
            <label>
              Mühendis
              <input value={project.engineer} onChange={(e) => update('engineer', e.target.value)} />
            </label>
            <label>
              İl
              <input value={project.province} onChange={(e) => update('province', e.target.value)} />
            </label>
            <label>
              İlçe
              <input value={project.district} onChange={(e) => update('district', e.target.value)} />
            </label>
            ...
            <label className="project-form-wide">
              Parsel Bilgisi
              <input value={project.parcelInfo} onChange={(e) => update('parcelInfo', e.target.value)} />
            </label>
          </div>
        </section>
        ...
        <section className="calculation-card">
          ...
          <div className="project-form-grid">
            <label>
              İşveren
              <input value={project.clientName} onChange={(e) => update('clientName', e.target.value)} />
            </label>
            <label>
              Firma
              <input value={project.firmName} onChange={(e) => update('firmName', e.target.value)} />
            </label>
            <label>
              Yapı Türü
              <input value={project.buildingType} onChange={(e) => update('buildingType', e.target.value)} />
            </label>
            <label>
              Bodrum Katı
              <input type="number" min="0" value={project.basementCount} onChange={(e) => update('basementCount', Number(e.target.value))} />
            </label>
            <label>
              Normal Kat
              <input type="number" min="0" value={project.normalFloorCount} onChange={(e) => update('normalFloorCount', Number(e.target.value))} />
            </label>
          </div>
        </section>
        ...
        <section className="calculation-card project-units-card">
          ...
          <div className="project-unit-row">
            ...
            <select
              ...
              onChange={(e) => update('unitSystem', e.target.value as UnitSystem)}
            >
        ...
        <section className="calculation-card">
          <button
            className="project-documents-toggle"
