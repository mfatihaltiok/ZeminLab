...
export function JetGroutEngineeringScreen() {
  ...
  }):undefined,[ready,d,spacing,layout,soil,column,soilEs,columnEs,soilC,columnC,thickness,phi,c,angle,p.unitSystem,p.foundationParameters.structuralWeight,p.foundationParameters.vtX,p.foundationParameters.vtY])
