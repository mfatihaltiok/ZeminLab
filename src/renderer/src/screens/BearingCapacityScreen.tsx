...
export function BearingCapacityScreen({profile}:{profile?:IdealizedSoilProfile}){
 ...
 const inputsValid=
  ...
  (!Number.isFinite(soil.groundwaterDepth)||soil.groundwaterDepth<0|| (Number.isFinite(gamma2)&&gamma2>0))&&
 ...
 const gammaSatDisplay=Number.isFinite(gamma2)&&gamma2>0?gamma(gamma2):'—'
   ...
   <Card title="ANALİZ HAZIR DEĞİL">
    <div className="engineering-note">
     ...
     <ul>
      ...
      <li>Df ≥ 0</li>
      <li>γ &gt; 0; YASS tanımlıysa γsat &gt; 0</li>
      <li>c ≥ 0 ve φ ≥ 0°</li>
