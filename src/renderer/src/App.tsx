...
function App() {
  ...
  const [activeScreen, setActiveScreen] =
    useState<ScreenId>('soil-profile')
  ...
  const currentScreen =
    screenDefinitions[activeScreen]
      ...
      <div className="toolbar">
        ...
        <div className="toolbar-section">
          <button
            ...
            onClick={() => selectTreeItem('Sondajlar')}
          >
            <span className="tool-symbol">▤</span>
            <span>Sondaj</span>
          </button>
          ...
          <button
            className="tool-button"
            onClick={() => selectTreeItem('SPT Kayıtları')}
          >
          ...
          <button
            className="tool-button"
            onClick={() => selectTreeItem('Laboratuvar')}
          >
            <span className="tool-symbol">▥</span>
        ...
        <div className="toolbar-section">
          <button
            className="tool-button emphasis"
            onClick={() => selectTreeItem('Taşıma Gücü')}
          >
          ...
          <button
            className="tool-button"
            onClick={() => selectTreeItem('Jet Grout')}
          >
            <span className="tool-symbol">▦</span>
            <span>Jet Grout</span>
          </button>
          ...
          <button
            className="tool-button"
            onClick={() => selectTreeItem('Mühendislik Raporu')}
          >
            <span className="tool-symbol">▤</span>
            <span>Rapor</span>
          </button>
      ...
      <main className="main-layout">
        ...
        <aside className="panel explorer-panel">
          ...
          <div className="tree">
            ...
            <TreeItem
              ...
              active={activeScreen === 'project-info'}
              onSelect={() => selectTreeItem('Proje Bilgileri')}
            />
            ...
            <TreeItem label="Saha Bilgileri">
              ...
              <TreeItem label="Sondajlar">
                ...
                <TreeItem
                  label="Sondaj-01"
                  active={selected === 'Sondaj-01'}
                  onSelect={() => selectBorehole('Sondaj-01')}
                />

                <TreeItem
                  label="Sondaj-02"
                  active={selected === 'Sondaj-02'}
                  onSelect={() => selectBorehole('Sondaj-02')}
                />
                ...
                <TreeItem
                  ...
                  active={
                    selected === 'Sondaj-03' &&
                    activeScreen === 'soil-profile'
                  }
                  onSelect={() => selectBorehole('Sondaj-03')}
                >
              ...
              <TreeItem
                label="SPT Kayıtları"
                active={activeScreen === 'spt'}
                onSelect={() => selectTreeItem('SPT Kayıtları')}
              />

              <TreeItem
                label="Laboratuvar"
                active={activeScreen === 'laboratory'}
                onSelect={() => selectTreeItem('Laboratuvar')}
              />

              <TreeItem
                label="Zemin Profili"
                active={activeScreen === 'soil-profile'}
                onSelect={() => selectTreeItem('Zemin Profili')}
              />
            ...
            <TreeItem label="Analiz">
              ...
              <TreeItem
                label="Zemin Parametreleri"
                active={activeScreen === 'soil-parameters'}
                onSelect={() =>
                  selectTreeItem('Zemin Parametreleri')
                }
              />

              <TreeItem
                label="Taşıma Gücü"
                active={activeScreen === 'bearing-capacity'}
                onSelect={() =>
                  selectTreeItem('Taşıma Gücü')
                }
              />

              <TreeItem
                label="Oturma"
                active={activeScreen === 'settlement'}
                onSelect={() => selectTreeItem('Oturma')}
              />

              <TreeItem
                label="Sıvılaşma"
                active={activeScreen === 'liquefaction'}
                onSelect={() =>
                  selectTreeItem('Sıvılaşma')
                }
              />
            ...
            <TreeItem label="Tasarım">
              ...
              <TreeItem
                label="Temel"
                active={activeScreen === 'foundation'}
                onSelect={() => selectTreeItem('Temel')}
              />

              <TreeItem
                label="Jet Grout"
                active={activeScreen === 'jet-grout'}
                onSelect={() =>
                  selectTreeItem('Jet Grout')
                }
              />
            ...
            <TreeItem label="Rapor">
              ...
              <TreeItem
                label="Hesap Kontrolü"
                active={activeScreen === 'calculation-check'}
                onSelect={() =>
                  selectTreeItem('Hesap Kontrolü')
                }
              />

              <TreeItem
                label="Mühendislik Raporu"
                active={activeScreen === 'engineering-report'}
                onSelect={() =>
                  selectTreeItem('Mühendislik Raporu')
                }
              />
        ...
        <section className="workspace">
          ...
          <div className="workspace-tabs">
            ...
            {tabs.map((tab) => (
              <button
                ...
                onClick={() => {
                  ...
                  if (tab === 'Zemin Profili') {
                    setActiveScreen('soil-profile')
                  }

                  if (tab === 'Sondaj-03') {
                    setSelected('Sondaj-03')
                    setActiveScreen('soil-profile')
                  }
                }}
              >
            ...
            <button className="workspace-tab-action">
              ＋
            </button>
