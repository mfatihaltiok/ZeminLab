...
export const defaultProjectInfo:ProjectInfo={
  ...
  foundationParameters:{
    ...
    resistanceFactorRv:1.4,vtX:0,vtY:0,structuralWeight:0,baseFrictionTanDelta:0.6,passiveResistanceCharacteristic:0,usePassiveResistance:false,foundationInterface:undefined,seismicBelowGroundwater:undefined
  },
