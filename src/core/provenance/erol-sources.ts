...
/** Canonical Erol/Yuksel Proje references used across ZeminLab calculation engines. */
export const EROL_REFERENCES: ErolReference[] = [
  {
    ...
    url: 'https://www.yukselproje.com.tr/uploads/docs/1640872640_saha20211223vers01.pdf',
    scope: [
      'SPT', 'CPT', 'PMT', 'DMT', 'FVT',
      'SPT corrections', 'soil parameter correlations',
      'bearing capacity', 'settlement', 'pile capacity',
      'liquefaction', 'soil improvement correlations'
    ],
  ...
  },
  {
    ...
    scope: [
      'jet-soil interaction', 'jet grout design', 'column geometry',
      'mechanical properties', 'composite ground', 'applications',
      'geometric patterns', 'quality control', 'verification'
    ],
    reportUse: 'calculation-and-figure-source'
  }
]

export const EROL_SOURCE_KEYS = {
  fieldTests: 'EROL-CHEKINMEZ-2014',
  jetGrout: 'EROL-CHEKINMEZ-BAYRAM-2018-JET'
} as const

export function getErolReference(key: string): ErolReference | undefined {
  return EROL_REFERENCES.find(source => source.key === key)
}
