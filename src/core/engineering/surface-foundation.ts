...
export function calculateSurfaceFoundation(i:SurfaceFoundationInput):SurfaceFoundationResult{
 ...
 const resultBase={Nq:f.Nq,Nc:f.Nc,Ngamma:f.Ngamma,...mf,surcharge:qBase,gammaBelow,ex,ey,Be,Le,effectiveArea,qk,qt,qo,utilization,adequate,effectiveDepth:2*Bp,representativeC:i.c,representativePhi:f.phi,representativeGamma:gammaBelow,ultimateClassical:qk,allowableClassical:finite(i.safetyFactor)&&i.safetyFactor!>0?qk/i.safetyFactor!:undefined,undrainedQk,layeredScreeningOnly,finalDesignEligible,layerChecks:checks,warnings,method,foundationType}
