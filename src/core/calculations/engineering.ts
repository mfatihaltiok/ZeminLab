...
/** Legacy/literature single-layer bearing capacity. Internal base is kN/m²; UI converts to project units. */
...
/** TBDY 2018 surface-foundation engine. Inputs are normalized by the caller from the selected Ton-m or kN-m project system. */
...
/** Winkler ks. Result unit follows the selected project system: tonf/m³ or kN/m³. */
...
export const SOURCE_NOTES={
 ...
 bearing:'TBDY 2018 16.8.3.2 ve Denklem 16.8: yüzeysel temel taşıma gücü. ZeminLab proje birimleri: m + Ton-m veya kN-m; sonuçlar seçilen sistemde gösterilir.',
 settlement:'TBDY 2018 Bölüm 16: taşıma gücü ve yerdeğiştirme koşulları birlikte değerlendirilir.',
 stressSpread:'2:1 gerilme yayılımı; gerilme birimi seçilen proje sistemine, boyutlar m sistemine bağlıdır.',
 subgrade:'Winkler ks; 2. yöntem elastik yarı-uzaydan eşdeğer Winkler yaklaşımıdır. Sonuç seçilen proje sisteminde tonf/m³ veya kN/m³ verilir.',
